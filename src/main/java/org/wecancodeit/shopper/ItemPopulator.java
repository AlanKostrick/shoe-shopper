...
public class ItemPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Item converseShoes = new Item("Converse",
		...
		Item adidasShoes = new Item("Adidas",
		...
		Item reebokShoes = new Item("Reebok",
